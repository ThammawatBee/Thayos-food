...
const LoginPage = () => {
  ...
  return <Box height={'90vh'} display='flex' alignItems='center' justifyContent='center'>
    <form onSubmit={formik.handleSubmit}>
      <Box display={'flex'} justifyContent={'center'} paddingX={{ base: "20px", lg: "0px" }}>
        <Box shadow={'0 4px 6px -1px rgba(0, 0, 0, .1), 0 2px 4px -2px rgba(0, 0, 8, .1)'} width={{ base: "100%", lg: "400px" }} padding="20px" border={"1px solid #ECECEC"} borderRadius="10px">
